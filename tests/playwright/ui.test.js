...
test.describe('TerminAI Webview UI Tests', function() {
    ...
    test('should handle basic command input', async ({ page }) => {
    ...
    test('should switch to deepseek AI service', async ({ page }) => {
    ...
    test('should handle ls command and display results', async ({ page }) => {
        // Type ls command
