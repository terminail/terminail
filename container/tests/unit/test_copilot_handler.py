"""
Unit tests for Microsoft Copilot AI handler
"""
import pytest
from unittest.mock import AsyncMock
from mcp_server.handlers.copilot_handler import CopilotHandler
from mcp_server.ai_handler_base import AIHandler


class TestCopilotHandler:
    """Test cases for CopilotHandler"""
    
    def test_handler_instantiation(self):
        """Test CopilotHandler instantiation"""
        mock_page = AsyncMock()
        handler = CopilotHandler(mock_page)
