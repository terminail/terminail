"""
Unit tests for Claude AI handler
"""
import pytest
from unittest.mock import AsyncMock
from mcp_server.handlers.claude_handler import ClaudeHandler
from mcp_server.ai_handler_base import AIHandler


class TestClaudeHandler:
    """Test cases for ClaudeHandler"""
    
    def test_handler_instantiation(self):
        """Test ClaudeHandler instantiation"""
        mock_page = AsyncMock()
        handler = ClaudeHandler(mock_page)
