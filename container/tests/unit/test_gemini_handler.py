"""
Unit tests for Gemini AI handler
"""
import pytest
from unittest.mock import AsyncMock
from mcp_server.handlers.gemini_handler import GeminiHandler
from mcp_server.ai_handler_base import AIHandler


class TestGeminiHandler:
    """Test cases for GeminiHandler"""
    
    def test_handler_instantiation(self):
        """Test GeminiHandler instantiation"""
        mock_page = AsyncMock()
        handler = GeminiHandler(mock_page)
